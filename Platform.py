...
class Platform:
    ...
    def overlap(self, ego_position, other_position):     
        return ego_position[1] < other_position[3] and ego_position[3] > other_position[1] \
        and ego_position[2] > other_position[2] - 20 and ego_position[0] < other_position[0] + 20
...
class Goal:
    ...
    def overlap(self, ego_position, other_position):
        ...
        and ego_position[0] < other_position[2] and ego_position[3] + 5 > other_position[3] 